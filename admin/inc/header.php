        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <?php if (Session::get("userRole") == "0") {?>
                        <li class="ic-charts"><a href="adduser.php"><span>Add User</span></a>
                        </li>
                <?php   } ?>
